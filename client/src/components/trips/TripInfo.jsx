...
const TripInfo = ({ trip }) => {
	...
	const [ tripInfoEditHistory, setTripInfoEditHistory ] = useState({ new: {}, old: {} });
		...
		() => {
			...
			if (trip !== null) {
				setTripInfoEditHistory({
					new: (({ name, description, startDate, endDate }) => ({ name, description, startDate, endDate }))(trip),
					old: (({ name, description, startDate, endDate }) => ({ name, description, startDate, endDate }))(trip)
				});
			}
		},
		[ trip ]
