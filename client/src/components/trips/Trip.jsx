...
import { DELETE_STEP, EDIT_STEP } from '../../actions/types';
...
const Trip = ({ match, trips: { trip, gpxFiles }, getUserTrip }) => {
  ...
  //       if (step.gpxFilename) {
  //         const b64Gpx = Buffer.from(step.gpxFile).toString();
  //         const gpx = window.atob(b64Gpx);
  //         setGpxFiles((prevState) => ({
  //           ...prevState,
  //           [step._id]: gpx,
  //         }));
  //       }
